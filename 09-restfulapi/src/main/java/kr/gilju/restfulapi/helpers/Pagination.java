package kr.gilju.restfulapi.helpers;
...
public class Pagination {
  ...
  /***** 개발자가 정의해야 하는 값 *****/
  private int listCount = 5; // 한 페이지에 보여질 글의 목록 수
  private int groupCount = 2; // 한 그룹에 보여질 글의 목록 수
  ...
  private int nextPage = 0; // 이전그룹의 첫 페이지
  private int offset = 0; // mysql의 Limit 시작위치
